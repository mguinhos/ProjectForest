...
/** @type {string} */
const CACHE_VERSION = '1756730831|1492985813';
/** @type {string} */
const CACHE_PREFIX = 'Forest-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Forest.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Forest.html","Forest.js","Forest.offline.html","Forest.icon.png","Forest.apple-touch-icon.png","Forest.audio.worklet.js","Forest.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Forest.wasm","Forest.pck"];
